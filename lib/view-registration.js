...
/* webpackMode: "eager" */
         /* webpackExclude: /.data.|.autogenerated.|.test.|.field.|.data-model./ */
         'partner/modules/checkout-guest-profile/checkout-guest-profile.view.tsx'),
         {
            chunkName: () => 'partner-modules-checkout-guest-profile-checkout-guest-profile.view.tsx',
            ignoreBabelRename: true
         }
    )};
