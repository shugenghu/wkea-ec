...
viewDictionary['__local__|__local__|modules|index-person|index-person'] = {
component: universal(
   () => import(/* webpackInclude: /.(t|j)sx?$/ */ 
/* webpackMode: "eager" */
         /* webpackExclude: /.data.|.autogenerated.|.test.|.field.|.data-model./ */
         'partner/modules/index-person/index-person.view.tsx'),
         {
            chunkName: () => 'partner-modules-index-person-index-person.view.tsx',
            ignoreBabelRename: true
         }
    )};
