...
viewDictionary['__local__|__local__|modules|index-nav|index-nav'] = {
component: universal(
   () => import(/* webpackInclude: /.(t|j)sx?$/ */ 
/* webpackMode: "eager" */
         /* webpackExclude: /.data.|.autogenerated.|.test.|.field.|.data-model./ */
         'partner/modules/index-nav/index-nav.view.tsx'),
         {
            chunkName: () => 'partner-modules-index-nav-index-nav.view.tsx',
            ignoreBabelRename: true
         }
    )};
