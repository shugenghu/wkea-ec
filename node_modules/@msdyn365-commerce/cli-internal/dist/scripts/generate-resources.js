...
const getModuleResources = (isDefinitionExtension, themeName, exportSDKResources) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const promises = definitionFilesPaths.map((definitionFilePath) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (isDefinitionExtension && moduleDefinitionJSON.dependencies) {
            const oneOfProperty = (_b = (_a = moduleDefinitionJSON.dependencies) === null || _a === void 0 ? void 0 : _a.moduleLayout) === null || _b === void 0 ? void 0 : _b.oneOf;
            moduleAuthoringResources.dependencies = {};
            moduleAuthoringResources.dependencies.moduleLayout = {};
            moduleAuthoringResources.dependencies.moduleLayout.oneOf = [];
            oneOfProperty.forEach(configProperties => {
                ...
                moduleAuthoringResources.dependencies.moduleLayout.oneOf.push(authoringResourceProperties);
            });
        }
