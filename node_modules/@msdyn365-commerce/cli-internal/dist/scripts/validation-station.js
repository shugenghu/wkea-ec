...
function validatePackage(packagePath) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (connectorToValidate.length > 0) {
            return runConnectorValidation(connectorToValidate, status);
        }
...
function runConnectorValidation(connecter, status) {
    ...
    for (const [name, connectorPath] of connecter) {
        ...
        const validationResult = validator.validate(utilities_internal_1.safeReadJsonSync(connectorJsonFilePath), 
