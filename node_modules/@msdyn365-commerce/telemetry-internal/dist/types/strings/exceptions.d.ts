...
export declare const EXCEPTION_LOADDATA_ACTION_3 = "Encountered an error while processing ajax data action $0";
export declare const EXCEPTION_API_ROUTE1 = "missing id parameter";
export declare const EXCEPTION_API_ROUTE2 = "invalid action id parameter passed";
