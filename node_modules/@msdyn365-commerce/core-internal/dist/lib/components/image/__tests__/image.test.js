...
describe('Image Component', () => {
    ...
    it('Should render with "visibility": "hidden" inline style tag during initial load when there is a fallback image', () => {
        const mockGridSetting = {
            xs: { w: 768 },
            sm: { w: 992 },
            md: { w: 1200 },
        ...
        const mockImage = {
            src: 'https://www.microsoft.com/super-duper-gif.jpeg',
            fallBackSrc: 'https://www.microsoft.com/old-super-duper-gif.jpeg'
        };
        const mockImageSetting = {
            disableLazyLoad: true,
            viewports: {
