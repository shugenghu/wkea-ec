...
export declare const getRenderSlotComponent: (parentProps: {
    [x: string]: any;
}, moduleConfigs: IModuleContract<{}, unknown>[], slotId: string, addSiblingIndices?: number[] | undefined, isMounted?: boolean | undefined) => React.ReactNode[];
