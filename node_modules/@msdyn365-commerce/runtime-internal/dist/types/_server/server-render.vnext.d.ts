...
import { IPageConfig, IPageResponse, IRequestContext } from '@msdyn365-commerce/core-internal';
...
declare const serverRenderVnext: ({ content, context, options: { clientStats }, pageConfig, telemetry, moduleTelemetry, requestCache }: IRenderDefaultRouterOptions) => Promise<string>;
