 ...
 */
export declare const constructViewportInformationForImage: (moduleName: string, moduleLayout: string | undefined, pathToField: string[], quality: string, themeSettings: IPartnerThemeSettings, focalRegion?: IFocalRegion, cropRegions?: ICropRegion[], format?: string | undefined) => any;
