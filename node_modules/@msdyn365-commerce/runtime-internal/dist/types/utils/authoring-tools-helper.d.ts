...
export declare class AuthoringToolsHelper {
     ...
     */
    addModule(moduleType: string, moduleId: string, parentId: string, content: IModuleContent, moduleSlotName?: string, addIndex?: number, addFromPageFragment?: boolean): Promise<boolean>;
