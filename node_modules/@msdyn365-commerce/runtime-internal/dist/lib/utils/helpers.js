...
import { EXCEPTION_EXPECTED501, LogLevel, StaticTelemetry } from '@msdyn365-commerce/telemetry-internal';
...
export const verboseLogger = (context, telemetry, message) => {
    if (context.features && !!context.features.enable_verbose_logs) {
        telemetry.log(LogLevel.Information, message);
    }
};
