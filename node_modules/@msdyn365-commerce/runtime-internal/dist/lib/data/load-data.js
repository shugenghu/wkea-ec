...
export const loadData = async (modules, context, internalTelemetry, moduleTelemetry, requestCache, appCache, complexDataTypesPromises) => {
    ...
    const promises = processDataActionMetadataList(context, requestCache, dataActionMetadataList, moduleTelemetry, appCache, internalTelemetry);
    if (complexDataTypesPromises) {
...
const processDataActionMetadataList = (context, requestCache, dataActionMetadataList, moduleTelemetry, appCache, internalTelemetry) => {
