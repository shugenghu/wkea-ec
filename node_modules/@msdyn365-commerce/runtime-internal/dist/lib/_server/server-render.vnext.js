...
const makeLoadDataCalls = ({ internalTelemetry: telemetry, moduleTelemetry: moduleTelemetry, content, context, requestCache, appCache }, complexPromise) => {
    try {
...
const serverRenderVnext = async ({ content, context, options: { clientStats }, pageConfig, telemetry, moduleTelemetry, requestCache }) => {
    ...
    await makeLoadDataCalls({ content, context, requestCache, internalTelemetry: telemetry, moduleTelemetry: moduleTelemetry, appCache }, complexDataTypesPromises);
