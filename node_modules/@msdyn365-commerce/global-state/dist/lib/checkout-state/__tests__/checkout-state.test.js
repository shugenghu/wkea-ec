...
describe('BaseCheckoutState', () => {
    ...
    it('attributeValues have default values and can be updated', () => {
        const checkoutState = new BaseCheckoutState(actionContext);
        expect(checkoutState.attributeValues).toEqual([]);
        const newAttributeValues = [{ Name: 'attributeValues' }];
    ...
    it('extensionProperties have default values and can be updated', () => {
        const checkoutState = new BaseCheckoutState(actionContext);
        expect(checkoutState.extensionProperties).toEqual([]);
        const newExtensionProperties = [{ Key: 'key', Value: { StringValue: 'stringValue' } }];
    ...
    it('tender type has default value and can be updated', () => {
        const checkoutState = new BaseCheckoutState(actionContext);
        const newPaymentTenderType = 'newPaymentTenderType';
    ...
    it('giftCards can add extended gift card', () => {
        const checkoutState = new BaseCheckoutState(actionContext);
        const newGiftCard = { Id: '1', Pin: '1111', ExpirationDate: 'date-1', TenderTypeId: '12-1' };
        ...
        const anotherNewGiftCard = { Id: '2', Pin: '2222', ExpirationDate: 'date-2', TenderTypeId: '12-2' };
    ...
    it('giftCards can be removed', () => {
        const checkoutState = new BaseCheckoutState(actionContext);
        const giftCard1 = { Id: '1' };
        const giftCard2 = { Id: '2' };
        const giftCard3 = { Id: '3' };
    ...
    it('save DataInStorage', () => {
        ...
        const newAddress = {};
        const giftCard1 = { Id: '1' };
        const loyaltyCardNumber = '10000000';
        const loyaltyAmount = 123;
        const checkoutGenericData = { Data: 'data', SaveDataBeforeRedirect: true };
        const isTermsAndConditionAccepted = true;
        const paymentTenderType = 'testTender';
        // @ts-ignore: Jest Mocking Confuses TS Complier
        actionContext.requestContext.sessionStorage = {
    ...
    it('set setInitialData', async () => {
        const newAddress = {};
        const isBillingAddressSameAsShippingAddress = true;
        const giftCard1 = { Id: '1' };
        const loyaltyCardNumber = '10000000';
        const loyaltyAmount = 123;
        const checkoutGenericData = { Data: {} };
        const newAddressStoredData = { billingAddress: newAddress, isBillingAddressSameAsShippingAddress: isBillingAddressSameAsShippingAddress };
        const giftCardStoredData = [giftCard1];
        const loyaltyCardNumberStoredData = { loyaltyCardNumber: loyaltyCardNumber };
        const loyaltyAmountStoredData = { loyaltyAmount: loyaltyAmount };
        const checkoutStoredData = { checkoutData: checkoutGenericData };
        // @ts-ignore: Jest Mocking Confuses TS Complier
...
//# sourceMappingURL=checkout-state.test.js.map