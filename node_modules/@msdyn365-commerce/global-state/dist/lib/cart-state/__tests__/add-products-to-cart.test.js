...
describe('addProductsToCart', () => {
    ...
    const actionContextWithReducedMaxQuantity = core.buildMockActionContext({ requestContext: mockRequestContextReducedMaxQuantity });
    const actionContextWithNoSettings = core.buildMockActionContext({ requestContext: mockRequestContextNoSettings });
    const cartLine1 = {
        ProductId: 1,
        Quantity: 1
    };
    const cartLine1Count5 = {
        ProductId: 1,
        Quantity: 5
    };
    const cartLine1Count8 = {
        ProductId: 1,
        Quantity: 8
    };
    const cartLine1CountNone = {
        ProductId: 1
    };
    const cartLine2 = {
        ProductId: 3,
...
//# sourceMappingURL=add-products-to-cart.test.js.map