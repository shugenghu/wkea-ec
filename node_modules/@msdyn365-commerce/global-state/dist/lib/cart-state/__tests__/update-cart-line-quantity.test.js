...
describe('updateCartLineQuantity tests', () => {
    ...
    const actionContextNoSetting = core.buildMockActionContext({ requestContext: mockRequestContextNoSetting });
    const actionContextReduced = core.buildMockActionContext({ requestContext: mockRequestContextReduced });
    const sampleCart = {
        Id: 'cart1',
        CartLines: [
            {
...
//# sourceMappingURL=update-cart-line-quantity.test.js.map