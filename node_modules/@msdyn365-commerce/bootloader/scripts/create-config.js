...
const { MIN_CHUNK_SIZE } = require('../helper/chunking-helper');
...
module.exports = (target = 'web', env = 'dev', { host = 'localhost', port = 3000, devPort = 3001, modify }, webpackObject) => {
    ...
    if (IS_WEB) {
        ...
        if (IS_DEV) {
            ...
            const platforSettings = getPlatformSettings();
            let minClientChunkSize = platforSettings.minClientChunkSize || MIN_CHUNK_SIZE; // Any client chunks less than 10KB will be merged together by default
            ...
            config.plugins = [
                ...
                new webpack.optimize.MinChunkSizePlugin({
                    minChunkSize: minClientChunkSize
                })
            ];
