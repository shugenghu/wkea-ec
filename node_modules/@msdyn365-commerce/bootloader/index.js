...
const { updateCacheGroup, MIN_CHUNK_SIZE } = require('./helper/chunking-helper');

module.exports = async (
    originalConfig,
    { target, dev }, // eslint-disable-next-line no-unused-vars
    webpack,
    options
) => {
    ...
    updatedConfig.resolve.extensions = updatedConfig.resolve.extensions.concat(['.ts', '.tsx']);
    ...
    updatedConfig.plugins = [
        ...
        ...updatedConfig.plugins,
        new WriteFilePlugin(),
        new CopyWebpackPlugin(target === 'node' ? copywebpackPluginOptions : []),
        ...
        new ForkTsCheckerWebpackPlugin({
            ...
            tsconfig: path.resolve(paths.appSrc, '..', 'tsconfig.json'),
            // set tsconfig path to resolve from actual source dir
            tslint: path.resolve(paths.appSrc, '..', 'tslint.json'),
            formatter: require('tslint/lib/formatters/stylishFormatter.js').default,
        ...
        new webpack.DefinePlugin({
            ...
            // default GUID for dev environments
            'process.env.SUBMISSIONID': JSON.stringify(
                process.env.SUBMISSIONID === undefined ? '00000-00000-00000-00000' : process.env.SUBMISSIONID
            )
        })
    ];
    ...
    if (target === 'web') {
        ...
        if (!dev) {
            ...
            updatedConfig.output = {
                ...updatedConfig.output,
                chunkFilename: 'static/js/[id].[chunkhash:16].chunk.js'
            };
        }
        ...
        let cacheGroups = {
            ...
            vendors: {
                ...
                test: webpackModule =>
                    /node_modules/.test(webpackModule.resource) && !/@msdyn365-commerce-(themes|modules)/.test(webpackModule.resource),
                name: 'vendors',
                priority: -10
            }
        };
        ...
        updatedConfig.optimization = {
            ...updatedConfig.optimization,
            // don't give chunkIds friendly names, give them numerical IDs in both dev & prod
            namedChunks: false,
            ...
            splitChunks: {
                ...
                minChunks: 1,
                // default value is 5
                maxAsyncRequests: chunkGroupNumber + 5,
                // default value is 3
                maxInitialRequests: chunkGroupNumber + 3,
    ...
    if (target === 'node') {
        ...
        console.log(`Using Starter Kit version: ${sskVersion}`);
        console.log('----------------------------------------------------------------------');
    }
