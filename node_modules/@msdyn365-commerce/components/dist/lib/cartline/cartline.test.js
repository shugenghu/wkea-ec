...
describe('Cartline', () => {
    ...
    it('renders correctly when the product with dimensions is passed to it', () => {
        ...
        const cartline = render((React.createElement(CartLineItemComponent, { id: 'id', typeName: 'CartLineItem', context: mockCoreContext, resources: {
                sizeString: 'Size',
                colorString: 'Color',
                styleString: 'Style',
    ...
    it('renders correctly when the product without dimensions is passed to it', () => {
        ...
        const cartline = render((React.createElement(CartLineItemComponent, { id: 'id', typeName: 'CartLineItem', context: mockCoreContext, currentQuantity: 10, resources: {
                sizeString: 'Size',
                colorString: 'Color',
                styleString: 'Style',
                quantityDisplayString: 'Quantity',
    ...
    it('renders correctly when the product with dimensions is passed to it and quantity is editable', () => {
        ...
        const cartline = render((React.createElement(CartLineItemComponent, { id: 'id', typeName: 'CartLineItem', context: mockCoreContext, resources: {
                ...
                cartLine: cartLine,
                product: simpleProduct
            }, isQuantityEditable: true, currentQuantity: 2, maxQuantity: 5 })));
        expect(cartline).toMatchSnapshot();
    });
});
//# sourceMappingURL=cartline.test.js.map