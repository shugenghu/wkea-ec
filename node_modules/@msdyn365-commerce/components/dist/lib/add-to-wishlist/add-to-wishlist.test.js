...
describe('AddToWishlist', () => {
    ...
    const basicProductMissingDimensions = { RecordId: 55555, Dimensions: [{ DimensionTypeValue: 0 }] };
    const basicProductNoMissingDimensions = { RecordId: 55555, Dimensions: [{ DimensionTypeValue: 0, DimensionValue: { RecordId: 1, Value: 'Set' } }] };
    ...
    it('renders correctly with all params', () => {
        const addToWishlist = render((React.createElement(AddToWishlistComponent, { addToWishlistButtonText: addToWishlistText, removeFromWishlistButtonText: removeToWishlistText, nameOfWishlist: 'My Wishlist', id: 'id', typeName: 'type-name', context: mockCoreContext, data: { product: basicProduct, wishlists: [] } })));
        expect(addToWishlist).toMatchSnapshot();
    });
    it('doesProductExistInWishlist is false when wishlists is undefined', () => {
        const addToWishlist = mount((React.createElement(AddToWishlistComponent, { addToWishlistButtonText: addToWishlistText, removeFromWishlistButtonText: removeToWishlistText, nameOfWishlist: 'My Wishlist', id: 'id', typeName: 'type-name', context: mockCoreContext, data: { product: basicProduct } })));
    ...
    it('doesProductExistInWishlist is false when the array of wishlists is empty', () => {
        const addToWishlist = mount((React.createElement(AddToWishlistComponent, { addToWishlistButtonText: addToWishlistText, removeFromWishlistButtonText: removeToWishlistText, nameOfWishlist: 'My Wishlist', id: 'id', typeName: 'type-name', context: mockCoreContext, data: { product: basicProduct, wishlists: [] } })));
        const button = addToWishlist.find('button').first();
        expect(button.getDOMNode().getAttribute('aria-label')).toEqual(addToWishlistText);
        addToWishlist.unmount();
    });
    it('doesProductExistInWishlist is false when the wishlist is empty', () => {
        ...
        let addToWishlist = mount((React.createElement(AddToWishlistComponent, { addToWishlistButtonText: addToWishlistText, removeFromWishlistButtonText: removeToWishlistText, nameOfWishlist: 'My Wishlist', id: 'id', typeName: 'type-name', context: mockCoreContext, data: { product: basicProduct, wishlists: [{ Id: 333 }] } })));
        let button = addToWishlist.find('button').first();
        expect(button.getDOMNode().getAttribute('aria-label')).toEqual(addToWishlistText);
        addToWishlist.unmount();
        addToWishlist = mount((React.createElement(AddToWishlistComponent, { addToWishlistButtonText: addToWishlistText, removeFromWishlistButtonText: removeToWishlistText, nameOfWishlist: 'My Wishlist', id: 'id', typeName: 'type-name', context: mockCoreContext, data: { product: basicProduct, wishlists: [{ Id: 333, CommerceListLines: [] }] } })));
    ...
    it('doesProductExistInWishlist is false when the wishlist doesn not contain the product', () => {
        jest.spyOn(RetailActions, 'getCustomer').mockImplementation(() => Promise.resolve({ AccountNumber: 99999 }));
        const addToWishlist = mount((React.createElement(AddToWishlistComponent, { addToWishlistButtonText: addToWishlistText, removeFromWishlistButtonText: removeToWishlistText, nameOfWishlist: 'My Wishlist', id: 'id', typeName: 'type-name', context: mockCoreContext, data: { product: basicProduct, wishlists: wishlistsWithoutProduct } })));
        const button = addToWishlist.find('button').first();
        expect(button.getDOMNode().getAttribute('aria-label')).toEqual(addToWishlistText);
        addToWishlist.unmount();
    });
    it('doesProductExistInWishlist is true when the wishlist does contain the product', () => {
        jest.spyOn(RetailActions, 'getCustomer').mockImplementation(() => Promise.resolve({ AccountNumber: 99999 }));
        const addToWishlist = mount((React.createElement(AddToWishlistComponent, { addToWishlistButtonText: addToWishlistText, removeFromWishlistButtonText: removeToWishlistText, nameOfWishlist: 'My Wishlist', id: 'id', typeName: 'type-name', context: mockCoreContext, data: { product: basicProduct, wishlists: wishlistsWithProduct } })));
        const button = addToWishlist.find('button').first();
    ...
    it('Creates wishlist and adds wishlist items when the user does not have any wishlist', async () => {
        ...
        const addToWishlist = mount((React.createElement(AddToWishlistComponent, { addToWishlistButtonText: addToWishlistText, removeFromWishlistButtonText: removeToWishlistText, nameOfWishlist: 'My Wishlist', id: 'id', typeName: 'type-name', context: mockCoreContext, onSuccess: onClick, data: { product: basicProduct, wishlists: [] } })));
        const button = addToWishlist.find('button').first();
        button.simulate('click');
        await flushPromises();
    ...
    it('Adds item to the wishlist and if an itemID is provided, passes that in the callback', async () => {
        ...
        const onClick = jest.fn();
        const addToWishlist = mount((React.createElement(AddToWishlistComponent, { addToWishlistButtonText: addToWishlistText, removeFromWishlistButtonText: removeToWishlistText, nameOfWishlist: 'My Wishlist', id: 'id', cartline: mockCartLine, typeName: 'type-name', context: mockCoreContext, onSuccess: onClick, data: { product: basicProduct, wishlists: [] } })));
        const button = addToWishlist.find('button').first();
        button.simulate('click');
        await flushPromises();
        expect(Actions.createCommerceListAsync).toHaveBeenCalled();
    ...
    it('Doesnt add wishlist line and returns error when creating wishlist fails', async () => {
        ...
        const onClick = jest.fn();
        const addToWishlist = mount((React.createElement(AddToWishlistComponent, { addToWishlistButtonText: addToWishlistText, removeFromWishlistButtonText: removeToWishlistText, nameOfWishlist: 'My Wishlist', id: 'id', typeName: 'type-name', context: mockCoreContext, onError: onClick, data: { product: basicProduct, wishlists: [] } })));
        const button = addToWishlist.find('button').first();
        button.simulate('click');
        await flushPromises();
        expect(Actions.createCommerceListAsync).toHaveBeenCalled();
    ...
    it('Returns Error when adding a wishlist line fails', async () => {
        ...
        const onClick = jest.fn();
        const addToWishlist = mount((React.createElement(AddToWishlistComponent, { addToWishlistButtonText: addToWishlistText, removeFromWishlistButtonText: removeToWishlistText, nameOfWishlist: 'My Wishlist', id: 'id', typeName: 'type-name', context: mockCoreContext, onError: onClick, data: { product: basicProduct, wishlists: wishlistsWithoutProduct } })));
        const button = addToWishlist.find('button').first();
        button.simulate('click');
        await flushPromises();
        expect(Actions.addLinesAsync).toHaveBeenCalled();
    ...
    it('Returns Error and does not try to add line when product is missing dimensions and canAddMasterProduct is false', async () => {
        ...
        jest.spyOn(RetailActions, 'getCustomer').mockImplementation(() => Promise.resolve({ AccountNumber: 99999 }));
        const onClick = jest.fn();
        const addToWishlist = mount((React.createElement(AddToWishlistComponent, { addToWishlistButtonText: addToWishlistText, removeFromWishlistButtonText: removeToWishlistText, nameOfWishlist: 'My Wishlist', id: 'id', typeName: 'type-name', context: mockCoreContext, onError: onClick, canAddMasterProduct: false, data: { product: basicProductMissingDimensions, wishlists: wishlistsWithoutProduct } })));
        const button = addToWishlist.find('button').first();
        button.simulate('click');
        await flushPromises();
        expect(Actions.addLinesAsync).not.toHaveBeenCalled();
    ...
    it('Returns sucess and does try to add line when product is not missing dimensions and canAddMasterProduct is false', async () => {
        ...
        jest.spyOn(RetailActions, 'getCustomer').mockImplementation(() => Promise.resolve({ AccountNumber: 99999 }));
        const onClick = jest.fn();
        const addToWishlist = mount((React.createElement(AddToWishlistComponent, { addToWishlistButtonText: addToWishlistText, removeFromWishlistButtonText: removeToWishlistText, nameOfWishlist: 'My Wishlist', id: 'id', typeName: 'type-name', context: mockCoreContext, onSuccess: onClick, canAddMasterProduct: false, data: { product: basicProductNoMissingDimensions, wishlists: wishlistsWithoutProduct } })));
        const button = addToWishlist.find('button').first();
        button.simulate('click');
        await flushPromises();
        expect(Actions.addLinesAsync).toHaveBeenCalled();
    ...
    it('Returns Error and does not try to add line when product is missing dimensions and canAddMasterProduct is not set', async () => {
        ...
        jest.spyOn(RetailActions, 'getCustomer').mockImplementation(() => Promise.resolve({ AccountNumber: 99999 }));
        const onClick = jest.fn();
        const addToWishlist = mount((React.createElement(AddToWishlistComponent, { addToWishlistButtonText: addToWishlistText, removeFromWishlistButtonText: removeToWishlistText, nameOfWishlist: 'My Wishlist', id: 'id', typeName: 'type-name', context: mockCoreContext, onError: onClick, data: { product: basicProductMissingDimensions, wishlists: wishlistsWithoutProduct } })));
        const button = addToWishlist.find('button').first();
        button.simulate('click');
        await flushPromises();
        expect(Actions.addLinesAsync).not.toHaveBeenCalled();
    ...
    it('Returns success and does try to add line when product is missing dimensions and canAddMasterProduct is true', async () => {
        ...
        jest.spyOn(RetailActions, 'getCustomer').mockImplementation(() => Promise.resolve({ AccountNumber: 99999 }));
        const onClick = jest.fn();
        const addToWishlist = mount((React.createElement(AddToWishlistComponent, { addToWishlistButtonText: addToWishlistText, removeFromWishlistButtonText: removeToWishlistText, nameOfWishlist: 'My Wishlist', id: 'id', typeName: 'type-name', context: mockCoreContext, onSuccess: onClick, canAddMasterProduct: true, data: { product: basicProductMissingDimensions, wishlists: wishlistsWithoutProduct } })));
        const button = addToWishlist.find('button').first();
        button.simulate('click');
        await flushPromises();
        expect(Actions.addLinesAsync).toHaveBeenCalled();
...
//# sourceMappingURL=add-to-wishlist.test.js.map