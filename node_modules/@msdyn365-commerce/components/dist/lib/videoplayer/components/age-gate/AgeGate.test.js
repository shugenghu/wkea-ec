...
describe('AgeGate ', () => {
    it('AgeGate work correctly if more than minimum age is provided', () => {
        ...
        const wrapper = mount(React.createElement(AgeGate, { onSubmitClick: spySubmit, "aria-hidden": false, minmumAge: 18 }), { attachTo: document.body.firstElementChild });
        const ageGate = wrapper.instance();
...
//# sourceMappingURL=AgeGate.test.js.map