...
describe('star ratings', () => {
    ...
    const starGlyphProp = (stars, index) => {
        const star = stars.get(index);
        return star.props;
    };
    it('renders as a 4 star rating', () => {
        const wrapper = mount(React.createElement(RatingComponent, { className: 'myClass', avgRating: 3.75, ratingCount: '345', readOnly: true, context: mockCoreContext, ariaLabel: 'my aria label', id: 'foo', typeName: 'foo', data: {} }));
    ...
    it('renders as a 2.5 star rating', () => {
        const wrapper = mount(React.createElement(RatingComponent, { avgRating: 2.5, ratingCount: '345', readOnly: true, context: mockCoreContext, ariaLabel: 'my aria label', id: 'foo', typeName: 'foo', data: {} }));
        const stars = wrapper.find('span');
        expect(starGlyphProp(stars, 0).className).toContain(filledStar);
        expect(starGlyphProp(stars, 1).className).toContain(filledStar);
    ...
    it('renders as a 2 star rating', () => {
        const wrapper = mount(React.createElement(RatingComponent, { avgRating: 2.23, ratingCount: '345', readOnly: true, context: mockCoreContext, ariaLabel: 'my aria label', id: 'foo', typeName: 'foo', data: {} }));
        const stars = wrapper.find('span');
        expect(starGlyphProp(stars, 0).className).toContain(filledStar);
        expect(starGlyphProp(stars, 1).className).toContain(filledStar);
    ...
    it('renders 0 filled in stars when the user can set the rating', () => {
        const wrapper = mount(React.createElement(RatingComponent, { avgRating: 2.23, ratingCount: '345', readOnly: false, context: mockCoreContext, ariaLabel: 'my aria label', id: 'foo', typeName: 'foo', data: {} }));
        const stars = wrapper.find('span');
    ...
    it('sets the rating and propogates the change when the rangeslider updates', () => {
        ...
        const wrapper = mount(React.createElement(RatingComponent, { avgRating: 2.23, ratingCount: '345', readOnly: false, onChange: onChange, context: mockCoreContext, ariaLabel: 'my aria label', id: 'foo', typeName: 'foo', data: {} }), { attachTo: document.body.firstElementChild });
    ...
    it('does not throw error when input changes but no onChange is given', () => {
        const event = { currentTarget: { value: '4' }, target: { value: '4' } };
        const wrapper = mount(React.createElement(RatingComponent, { avgRating: 2.23, ratingCount: '345', readOnly: false, context: mockCoreContext, ariaLabel: 'my aria label', id: 'foo', typeName: 'foo', data: {} }), { attachTo: document.body.firstElementChild });
        const input = wrapper.find('input');
    ...
    it('does not sets the rating when user clicks on static rating', () => {
        const onChange = jest.fn();
        const wrapper = mount(React.createElement(RatingComponent, { avgRating: 2, ratingCount: '345', readOnly: true, onChange: onChange, context: mockCoreContext, ariaLabel: 'my aria label', id: 'foo', typeName: 'foo', data: {} }), { attachTo: document.body.firstElementChild });
        let stars = wrapper.find('span');
        expect(starGlyphProp(stars, 0).className).toContain(filledStar);
        expect(starGlyphProp(stars, 1).className).toContain(filledStar);
        expect(starGlyphProp(stars, 2).className).toContain(emptyStar);
    ...
    it('rating updates when the props change', () => {
        const wrapper = mount(React.createElement(RatingComponent, { className: 'myClass', avgRating: 1, ratingCount: '345', readOnly: true, context: mockCoreContext, ariaLabel: 'my aria label', id: 'foo', typeName: 'foo', data: {} }));
        let stars = wrapper.find('span');
        expect(starGlyphProp(stars, 0).className).toContain(filledStar);
        expect(starGlyphProp(stars, 1).className).toContain(emptyStar);
