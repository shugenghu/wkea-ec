...
describe('Product component renders correctly', () => {
    ...
    it('renders product correctly', () => {
        const wrapper = render((React.createElement(ProductComponent, { context: mockCoreContext, imageSettings: defaultImageSettings, id: 'test', typeName: 'test', data: { product: mockProduct }, telemetryContent: telemetryContent })));
        expect(wrapper).toMatchSnapshot();
    });
    it('returns null for a null product', () => {
        const wrapper = render((React.createElement(ProductComponent, { context: mockCoreContext, imageSettings: defaultImageSettings, id: 'test', typeName: 'test', data: {}, telemetryContent: telemetryContent })));
        expect(wrapper.find('a')).toHaveLength(0);
    });
    it('Image is not displayed for invalid images', () => {
        const wrapper = render((React.createElement(ProductComponent, { context: mockCoreContext, imageSettings: defaultImageSettings, id: 'test', typeName: 'test', data: { product: mockProductWithoutImage }, telemetryContent: telemetryContent })));
        expect(wrapper).toMatchSnapshot();
    });
    it('Product without a name', () => {
        const wrapper = render((React.createElement(ProductComponent, { context: mockCoreContext, imageSettings: defaultImageSettings, id: 'test', typeName: 'test', data: { product: mockProductWithoutName }, telemetryContent: telemetryContent })));
        expect(wrapper).toMatchSnapshot();
    });
    ...
    it('Product without rating information', () => {
        const wrapper = render((React.createElement(ProductComponent, { context: mockCoreContext, imageSettings: defaultImageSettings, id: 'test', typeName: 'test', data: { product: mockProductWithoutRating }, telemetryContent: telemetryContent })));
        expect(wrapper).toMatchSnapshot();
    });
});
