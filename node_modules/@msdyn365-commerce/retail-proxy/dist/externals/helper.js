...
const parseDuration = duration => {
    ...
    const result = { ms, __edmType: 'Edm.Time' };
    if (ns) {
        result.ns = ns;
    }
    return result;
...
const parseDateTimeOffset = (value, withOffset, nullOnError) => {
    ...
    result.setUTCFullYear(year, // Year.
...
export const jsonLightReadStringPropertyValue = (value, propertyType, recognizeDates) => {
    ...
    if (recognizeDates) {
        return (parseDateTimeOffset(value, false, /* nullOnError */ true) || parseDateTimeOffset(value, true, /* nullOnError */ true) || value);
    }
    return value;
};
