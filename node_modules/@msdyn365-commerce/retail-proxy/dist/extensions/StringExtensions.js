...
export const EMPTY = '';
export function convertToString(obj, accumulator = [], depth = 0) {
    if (!obj) {
        return null;
    }
 ...
 */
export function isObjectNotEmptyOrNull(value) {
 ...
 * @return {boolean} True if the object is empty or whitespace, false otherwise.
 */
export function isEmptyOrWhitespace(object) {
    if (object && typeof object !== 'string') {
 ...
 */
export function isNullOrWhitespace(object) {
    if (object && typeof object !== 'string') {
 ...
 */
export function padLeft(object, padString, length) {
    if (object && typeof object !== 'string') {
 ...
 */
export function padRight(object, padString, length) {
    if (object && typeof object !== 'string') {
 ...
 */
export function format(object, ...params) {
    if (object && typeof object !== 'string') {
        // Tracer.Error("StringExtensions.isEmptyOrWhitespace has received input parameter not of type string.");
    }
...
export function compare(object, comparisonObject, ignoreCase) {
    ...
    const val1 = ignoreCase ? object.toLowerCase() : object;
    const val2 = ignoreCase ? comparisonObject.toLowerCase() : comparisonObject;
...
export function endsWith(str, suffix, caseSensitive = false) {
    ...
    const originalString = caseSensitive ? str : str.toLowerCase();
    const subString = caseSensitive ? suffix : suffix.toLowerCase();
