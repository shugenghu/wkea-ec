 ...
 */
export declare type CacheType = 'none' | 'instance' | 'application' | 'request';
/**
 * BypassCache type.
 */
export declare type BypassCache = 'none' | 'get' | 'put' | 'getAndPut';
export declare enum ICacheSource {
    RequestCache = 0,
    AppCache = 1
}
...
export interface ICache {
     ...
     */
    getAllItems<T = unknown>(typeName: string): {
        [cacheKey: string]: ICacheItem<T>;
    } | undefined;
    /**
     * @param cacheKey  {ICacheKey}     - object to build the cache key
