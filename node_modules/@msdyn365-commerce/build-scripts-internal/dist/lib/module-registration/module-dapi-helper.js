...
var ModulesDAPIHelper = /** @class */ (function () {
    function ModulesDAPIHelper() {
        ...
        this._dapiModulesPreviewData = {};
        this._dapiThemePreviewData = {};
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Promise.all((Object.keys(modules) || []).map(function (moduleType) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                                var moduleRegObj, definition, previewData, dataJson;
                                return tslib_1.__generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                        ...
                                        case 1:
                                            definition = _a.sent();
                                            return [4 /*yield*/, this._getModulePreviewData(moduleRegObj)];
                                        case 2:
                                            previewData = _a.sent();
                                        ...
                                        case 3:
                                            ...
                                            // if this module has preview data, we add preview data to dapi file.
                                            if (previewData) {
                                                this._dapiModulesPreviewData[moduleRegObj.name] = previewData;
                                            }
                                            return [2 /*return*/];
                                    }
                                });
        ...
        this.generateThemesDAPI = function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this;
                        return [4 /*yield*/, themes_dapi_helper_1.getThemesDAPIList(this._registeredModules, this._dapiModulesList, this._dapiThemePreviewData)];
                    case 1:
                    ...
                    case 4:
                        _b.sent();
                        return [4 /*yield*/, utilities_internal_1.safeWriteJson(models_1.keystonePaths.KEYSTONE_APP_DAPI_THEME_PREVIEW_DATA, this._dapiThemePreviewData)];
                    case 5:
                        _b.sent();
                        return [2 /*return*/];
                }
        ...
        this.generateModuleDefinitionDAPI = function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, utilities_internal_1.safeWriteJson(models_1.keystonePaths.KEYSTONE_APP_DAPI_MODULE_PREVIEW_DATA, this._dapiModulesPreviewData)];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        this._getModulePreviewData = function (moduleBinder) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var defaultPreviewDataPattern, defaultDataFilePaths, defaultMockDatas, _i, defaultDataFilePaths_1, defaultDataFilePath, defaultDataObj, defaultDataName;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        defaultPreviewDataPattern = path_1.default.join(moduleBinder.moduleDirectory || path_1.default.dirname(moduleBinder.definitionPath), 'previews', '*.preview.json');
                        return [4 /*yield*/, utilities_internal_1.safeGetAllFilesPath(defaultPreviewDataPattern)];
                    case 1:
                        defaultDataFilePaths = _a.sent();
                        defaultMockDatas = {};
                        _i = 0, defaultDataFilePaths_1 = defaultDataFilePaths;
                        _a.label = 2;
                    case 2:
                        if (!(_i < defaultDataFilePaths_1.length)) return [3 /*break*/, 5];
                        defaultDataFilePath = defaultDataFilePaths_1[_i];
                        return [4 /*yield*/, utilities_internal_1.safeReadJson(defaultDataFilePath)];
                    case 3:
                        defaultDataObj = _a.sent();
                        if (defaultDataObj) {
                            defaultDataName = path_1.default.basename(defaultDataFilePath).replace('.preview.json', '');
                            defaultMockDatas[defaultDataName] = defaultDataObj;
                        }
                        _a.label = 4;
                    case 4:
                        _i++;
                        return [3 /*break*/, 2];
                    case 5: return [2 /*return*/, Object.keys(defaultMockDatas).length > 0 ? defaultMockDatas : undefined];
                }
            });
        }); };
