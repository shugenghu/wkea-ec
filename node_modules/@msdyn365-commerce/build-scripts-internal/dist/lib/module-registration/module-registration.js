...
var msdyn365_plugin_1 = require("../msdyn365-plugin");
...
var supportedConnector = ['experimentation', 'geoLookup'];
...
var validateSelectedConnectors = function (connectorDefinition, connectorSettings) {
    var connectorType = connectorDefinition.$type;
    var connector = msdyn365_plugin_1.MapConnectorTypeToConnector(connectorType);
    if (connector && supportedConnector.includes(connector) && connector in connectorSettings) {
        if (connectorDefinition.configSchema && Object.keys(connectorDefinition.configSchema).length !== 0) {
            // @ts-ignore
            var validateResult = jsonschema_1.validate(connectorSettings[connector].config, connectorDefinition.configSchema);
...
var prepareConnectorDefinitionPath = function (connectorDefinitionAbsolutePath, connectorSettings) { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
    var connectorDefinition, isHoisted, isNodeDataAction, hoistedRelativePath, fullyResolvedPath, aliasedPath, aliasedPath;
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                else if (connectorDefinition.$type === 'geoLookupConnector') {
                    aliasedPath = path.join(!isNodeDataAction && !isHoisted ? 'partner' : '', "" + fullyResolvedPath);
                    return [2 /*return*/, {
                            name: connectorDefinition.name,
                            aliasedPaths: { provider: aliasedPath + ".provider" },
                            type: connectorDefinition.$type
                        }];
                }
                else {
 ...
 */
exports.getModuleDetails = function (filePath) {
        ...
        switch (_b.label) {
            ...
            case 1:
                ...
                for (i = 0; i < viewFilePaths.length; i++) {
                    ...
                    _a = exports.getModuleDetails(viewFilePath), moduleNamespace = _a.moduleNamespace, packageName = _a.packageName, isHoisted = _a.isHoisted;
        ...
        switch (_b.label) {
            ...
            case 1:
                ...
                for (i = 0; i < componentFilePaths.length; i++) {
                    ...
                    _a = exports.getModuleDetails(componentFilePath), moduleNamespace = _a.moduleNamespace, packageName = _a.packageName, isHoisted = _a.isHoisted;
...
exports.generateModuleRegistration = function (isLocal) { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
    ...
    return tslib_1.__generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                promises = [
                    // Function.name is undefined for msdyn365ModuleDefinitionGlobPattern. Need to pass function name manuly.
                    utilities_internal_1.safeGetAllFilesPathWithCache(isLocal, registration_utils_1.msdyn365ModuleDefinitionGlobPattern, 'msdyn365ModuleDefinitionGlobPattern'),
                ...
                return [4 /*yield*/, Promise.all(definitionFilePaths.map(function (definitionFilePath) { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
                        ...
                        return tslib_1.__generator(this, function (_c) {
                            switch (_c.label) {
                                ...
                                case 1:
                                    definition = _c.sent();
                                    _a = exports.getModuleDetails(definitionFilePath), moduleNamespace = _a.moduleNamespace, packageName = _a.packageName;
                                    _c.label = 2;
                                case 2:
                                    _c.trys.push([2, 8, , 9]);
