        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    // copy default data
                    return [4 /*yield*/, copyModulePreviews(module_registration_model_1.localModuleDefaultDataPathPattern)];
                case 1:
                    // copy default data
                    _a.sent();
                    return [2 /*return*/];
 ...
 * resolved json to the output (build) path
 *
 * @param moduleFileGlogPattern The path to the preview data.
 */
function copyModulePreviews(defaultPreviewDataFilePattern) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        var defaultPreviewData, e_1;
        var _this = this;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, utilities_internal_1.safeGetAllFilesPath(defaultPreviewDataFilePattern)];
                case 1:
                    defaultPreviewData = _a.sent();
                    if (defaultPreviewData.length === 0) {
                        utilities_internal_1.trace.info("No default data found with pattern " + defaultPreviewDataFilePattern);
                    }
                    _a.label = 2;
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, Promise.all(defaultPreviewData.map(function (filePath) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                ...
                case 4:
                    e_1 = _a.sent();
                    utilities_internal_1.trace.error("Error while copying default preview data. " + e_1);
                    return [3 /*break*/, 5];
    ...
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    e_2 = _a.sent();
                    utilities_internal_1.trace.error("Error while copying theme module definitions: " + e_2);
                    return [3 /*break*/, 5];
                case 5: return [2 /*return*/];
            }
        });
