...
export default class ActionExecutor {
    ...
    _checkForCachedData(inputs, context, requestCache, appCache, bypassAppCache, refreshing) {
        ...
        inputs.forEach((i, idx) => {
            ...
            if (cacheItem && isAsyncResult(cacheItem.item) && cacheItem.item.status === 'FAILED') {
                ...
                try {
                    const cacheEntries = readCacheEntries(i, requestCache, 
                    // @ts-ignore
                    appCache, !!!bypassAppCache && shouldReadFromAppCache(i, appCache));
