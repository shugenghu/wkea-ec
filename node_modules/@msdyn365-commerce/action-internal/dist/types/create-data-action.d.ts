 ...
 */
import { IAction } from '@msdyn365-commerce/core-internal';
import { dataActionOptions } from './wrap-data-action';
/**
 ...
 */
export declare const createDataAction: <TOut>(options: dataActionOptions<TOut>) => IAction<TOut>;
