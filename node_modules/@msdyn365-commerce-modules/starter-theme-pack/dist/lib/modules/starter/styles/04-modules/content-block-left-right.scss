...
&[data-m-layout='left-right'] {
  ...
  .ms-content-block__title {
    ...
    @include font-content($msv-font-weight-normal, var(--msv-content-block-heading-font-size), $feature-heading-line-height);
  }

  .ms-content-block__text {
    color: var(--msv-content-block-textheme-dark);
    @include font-content($msv-font-weight-normal, var(--msv-content-block-text-font-size), $feature-content-line-height);
  }
