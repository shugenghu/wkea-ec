...
$search-result-nav-title-margin: 10px 0px 5px 0px;
...
.ms-search-result-container__Sort-by-category {
    ...
    top: $search-result-container-nav-height + $search-result-container-nav-margin-bottom + $search-result-container-nav-margin-top;
