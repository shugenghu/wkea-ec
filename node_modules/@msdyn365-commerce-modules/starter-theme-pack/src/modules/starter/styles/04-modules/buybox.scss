...
.ms-buybox {
  ...
  @media (min-width: $msv-breakpoint-s) {
    ...
    &__product-title {
      @include font-content($msv-font-weight-bold, var(--msv-buybox-title-font-size),  $buybox-product-title-line-height);
      color: var(--msv-buybox-title-font-color);
      margin-bottom: $buybox-title-margin-bottom;
    }

    &__product-description {
      @include font-content($msv-font-weight-light, var(--msv-buybox-text-font-size), $msv-buybox-text-line-height);
