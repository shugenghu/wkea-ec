...
$msv-sign-up-success-border: 1px solid $msv-text-color;
$msv-sign-up-success-bg-color: $msv-gray-60;
$msv-sign-up-success-text-color: $msv-text-color;
$msv-sign-up-error-border: 1px solid $msv-white;
$msv-sign-up-error-bg-color: $msv-error-color;
