...
const AccountCustomerBalanceTileLinks = ({ links, telemetryContent, onTextChange, requestContext }) => {
    if (links.length === 0) {
        return null;
    }
    const editableLinks = _mapEditableLinks(links, telemetryContent);
    return (React.createElement("div", { className: 'ms-account-customer-balance-tile__links' }, editableLinks && editableLinks.length ?
...
//# sourceMappingURL=account-customer-balance-tile-links.js.map