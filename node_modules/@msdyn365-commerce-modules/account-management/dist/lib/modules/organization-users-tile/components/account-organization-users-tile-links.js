...
export const AccountOrganizationUsersTileLinks = ({ links, telemetryContent, onTextChange, requestContext }) => {
    if (links.length === 0) {
        return null;
    }
    const editableLinks = _mapEditableLinks(links, telemetryContent);
    return (React.createElement("div", { className: 'ms-account-organization-users-tile__links' }, editableLinks && editableLinks.length ?
...
//# sourceMappingURL=account-organization-users-tile-links.js.map