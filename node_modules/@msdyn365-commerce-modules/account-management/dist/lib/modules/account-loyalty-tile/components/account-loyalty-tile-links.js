...
const AccountLoyaltyTileLinks = ({ links, telemetryContent, onTextChange, requestContext }) => {
    if (links.length === 0) {
        return null;
    }
    const editableLinks = _mapEditableLinks(links, telemetryContent);
    return (React.createElement("div", { className: 'ms-account-loyalty-tile__links' }, editableLinks && editableLinks.length ?
...
//# sourceMappingURL=account-loyalty-tile-links.js.map