...
const AccountAddressTileLinks = ({ links, telemetryContent, requestContext, onTextChange }) => {
    if (links.length === 0) {
        return null;
    }
    const editableLinks = _mapEditableLinks(links, telemetryContent);
    return (React.createElement("div", { className: 'ms-account-address-tile__links' }, editableLinks && editableLinks.length ?
...
//# sourceMappingURL=account-address-tile-links.js.map