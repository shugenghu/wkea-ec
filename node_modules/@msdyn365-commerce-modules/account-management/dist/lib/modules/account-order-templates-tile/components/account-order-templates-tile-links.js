...
export const AccountOrderTemplatesTileLinks = ({ links, onTextChange, telemetryContent, requestContext }) => {
    if (links.length === 0) {
        return null;
    }
    const editableLinks = _mapEditableLinks(links, telemetryContent);
    return (React.createElement("div", { className: 'ms-account-order-templates-tile__links' }, editableLinks && editableLinks.length ?
...
//# sourceMappingURL=account-order-templates-tile-links.js.map