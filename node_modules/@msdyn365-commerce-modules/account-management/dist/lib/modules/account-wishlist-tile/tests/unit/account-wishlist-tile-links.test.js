...
describe('Account-Wishlist-Tile unit tests - Links', () => {
    it('renders correctly if no links is provideded', () => {
        const mockProps = {
            links: [],
            requestContext: buildMockRequest()
        };
        const component = render(React.createElement(LinksComponent, Object.assign({}, mockProps)));
...
//# sourceMappingURL=account-wishlist-tile-links.test.js.map