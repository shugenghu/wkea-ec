...
const AccountWishlistTileLinks = ({ links, telemetryContent, onTextChange, requestContext }) => {
    if (links.length === 0) {
        return null;
    }
    const editableLinks = _mapEditableLinks(links, telemetryContent);
    return (React.createElement("div", { className: 'ms-account-wishlist-tile__links' }, editableLinks && editableLinks.length ?
...
//# sourceMappingURL=account-wishlist-tile-links.js.map