...
const AccountGenericTileLinks = ({ links, telemetryContent, requestContext, onTextChange }) => {
    if (links.length === 0) {
        return null;
    }
    const editableLinks = _mapEditableLinks(links, telemetryContent);
    return (React.createElement("div", { className: 'ms-account-generic-tile__links' }, editableLinks && editableLinks.length ?
...
//# sourceMappingURL=account-generic-tile-links.js.map