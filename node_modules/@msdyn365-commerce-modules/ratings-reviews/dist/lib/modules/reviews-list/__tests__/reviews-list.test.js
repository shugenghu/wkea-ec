...
const mockActions = {};
const mockAuthenticatedContextNotSignedIn = {
    request: {
        user: {
            token: 'Dummy token',
...
const mockAuthenticatedContextSignedIn = {
    request: {
        user: {
            token: 'Dummy token',
...
describe('Reviews list - ContainsReviewsAndDoesntHaveNextButton', () => {
    ...
    beforeAll(() => {
        mockData = {
            userReview: RetailActions.wrapInResolvedAsyncResult({ rating: 4, title: 'my title', reviewText: 'my text' }),
            ratingsSummary: ratingsSummary,
            product: RetailActions.wrapInResolvedAsyncResult(undefined),
            ratingsReviewsState: RetailActions.wrapInResolvedAsyncResult(undefined),
        ...
        moduleProps = { ...buildMockModuleProps(mockData, mockActions, mockConfig, mockAuthenticatedContextSignedIn), resources: resources, renderView: jest.fn(props => { return React.createElement("div", { props: props }); }) };
    });
    it('renders correctly', async () => {
        const component = mount(React.createElement(ReviewsList, Object.assign({}, moduleProps)));
    ...
    it('toggleReviewModal will reset the modal inputs to the user review when opened', async () => {
        ...
        const button = mount(viewProps.userReview.edit);
    ...
    it('open/close report review modal', async () => {
        ...
        const button = mount(viewProps.reviewCards[0].report);
        button.simulate('click');
        ...
        expect(component.state('reportedKey')).toBe("8");
    ...
    it('Changing sorting updates the reviews', async () => {
        ...
        await moduleProps.data.reviewsList;
        const viewProps = component.childAt(0).props().props;
        const sortBy = mount(viewProps.sortByDropdown);
...
//# sourceMappingURL=reviews-list.test.js.map