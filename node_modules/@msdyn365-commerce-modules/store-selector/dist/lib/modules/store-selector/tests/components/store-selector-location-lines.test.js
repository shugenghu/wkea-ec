...
describe('Store selector location lines  tests', () => {
    ...
    it('should renders correctly when locations has locations and selected location specified', () => {
        const wrapper = mount(React.createElement(StoreSelectorLocationLines, Object.assign({}, mockProps, { enableOutOfStockCheck: false, locations: mockLocationList, alreadySelectedLocation: { OrgUnitName: 'Bellevue', OrgUnitNumber: '2' }, selectedStoreLocationId: '2' })));
