 ...
 * ICheckoutOrderConfirmation contentModule Interface Properties
 * THIS FILE IS AUTO-GENERATED - MANUAL MODIFICATIONS WILL BE LOST
 */

import * as Msdyn365 from '@msdyn365-commerce/core';

export interface ICheckoutOrderConfirmationConfig extends Msdyn365.IModuleConfig {
...
export interface ICheckoutOrderConfirmationResources {
    loadingLabel: string;
...
export interface ICheckoutOrderConfirmationProps<T> extends Msdyn365.IModule<T> {
    resources: ICheckoutOrderConfirmationResources;
    config: ICheckoutOrderConfirmationConfig;
}
