...
export const mockStoreAddress: Address = {
...
export const mockTenderLines: TenderLine[] = [
    {
        TenderTypeId: '3',
...
export const mockSalesOrderWithReceiptId: SalesOrder = {
    ...mockSalesOrder,
    ReceiptId: '012660-RECEIPT-ID',
    SalesId: ''
};

export const mockSalesOrderWithReceiptIdAndOrderId: SalesOrder = {
    ...mockSalesOrder,
    ReceiptId: '012660-RECEIPT-ID',
    SalesId: '012660-ORDER-ID'
};

export const mockTransaction: SalesOrder = {
...
export const mockProducts: SimpleProduct[] = [
    {
...
export const mockRequestContextJson = <unknown>{
    url: {
