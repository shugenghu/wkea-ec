...
const mockData = {
    orderTemplates: wrapInResolvedAsyncResult([mockOrderTemplate]),
};
const mockConfig = {
    heading: {
...
describe('OrderTemplateList', () => {
    ...
    it('renders correctly', () => {
        const orderTemplates = mount(React.createElement(OrderTemplateList, Object.assign({}, moduleProps)));
    ...
    it('renders loading message correctly', () => {
        ...
        const orderTemplateList = mount(React.createElement(OrderTemplateList, Object.assign({}, moduleProps)));
        expect(moduleProps.renderView).toBeCalled();
...
//# sourceMappingURL=order-template-list.test.js.map