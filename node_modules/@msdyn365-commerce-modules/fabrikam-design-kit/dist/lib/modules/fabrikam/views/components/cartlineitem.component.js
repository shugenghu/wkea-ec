    ...
    renderDiscountLines: (props) => {
        ...
        return props.data.cartLine.DiscountLines.map((discountLine, index) => {
            return (React.createElement("div", { key: discountLine.OfferId || index, className: 'msc-cart-line-item-product-discount' },
                ...
                React.createElement("span", { className: 'cart-line-item-product-discount-price' },
                    React.createElement(PriceComponent, { data: props.isSalesLine ? {
                        ...
                        }, context: props.context, id: props.id, typeName: props.typeName })),
    ...
    const _generateQuantityandPrice = () => {
        ...
        if (props.isQuantityEditable) {
            ...
            nodes.push(React.createElement("div", { className: classNames('msc-cart-line__quantity', { 'single-quantity': props.data.cartLine.Quantity === 1 }) },
                React.createElement("label", { className: 'quantity-label' },
                    resources.quantityDisplayString,
                    ":"),
                _generateErrorMessage(),
                React.createElement("span", { className: 'quantity-value' }, props.data.cartLine.Quantity)));
        }
        nodes.push(React.createElement("div", { className: 'msc-cart-line__product-savings' },
            React.createElement(PriceComponent, { data: isSalesLine ? {
                ...
                }, context: props.context, id: props.id, typeName: props.typeName, className: 'msc-cart-line__product-savings-actual', originalPriceText: resources.originalPriceText, currentPriceText: resources.currentPriceText }),
            props.data.cartLine.DiscountAmount && props.data.cartLine.DiscountAmount > 0 &&
                React.createElement(React.Fragment, null,
                    React.createElement("span", { className: 'msc-cart-line__product-savings-label' }, ` ${props.resources.discountStringText || 'Discount'} `),
                    React.createElement(PriceComponent, { data: props.isSalesLine ? {
                            price: {
                                CustomerContextualPrice: props.data.cartLine.PeriodicDiscount
                            }
                        ...
                        }, context: props.context, id: props.id, typeName: props.typeName, className: 'msc-cart-line__product-savings-text' })) ||
                null));
        return nodes;
    };
        ...
        React.createElement("div", { className: 'msc-cart-line__content' },
            React.createElement("div", { className: 'msc-cart-line__product' },
                ...
                productDimensions.length > 0 ?
                    ...
                    '',
                React.createElement("div", { className: 'msc-cart-line__product-price' },
                    React.createElement(PriceComponent, { data: isSalesLine ? {
                            price: {
                                CustomerContextualPrice: props.data.cartLine.NetAmount,
                                BasePrice: props.data.cartLine.Price
                        ...
                        }, context: props.context, id: props.id, typeName: props.typeName, className: 'discount-value' })),
                renderDisountLines,
