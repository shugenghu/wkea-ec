...
export interface IBusinessAccountAddressConfig extends Msdyn365.IModuleConfig {
    className?: string;
}
export interface IBusinessAccountAddressResources {
...
export interface IBusinessAccountAddressProps<T> extends Msdyn365.IModule<T> {
    resources: IBusinessAccountAddressResources;
    config: IBusinessAccountAddressConfig;
}
