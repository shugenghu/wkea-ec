...
const mockData = {
    ...
    countryRegions: AsyncResult.resolve([]),
...
describe('CheckoutBillingAddress', () => {
    ...
    beforeAll(() => {
        ...
        moduleProps = { ...buildMockModuleProps(mockData, mockActions, mockConfig, mockContext), resources: mockResources };
    ...
    xit('renders correctly', () => {
        const component = renderer.create(React.createElement(CheckoutBillingAddress, Object.assign({}, moduleProps)));
        const tree = component.toJSON();
        expect(tree).toMatchSnapshot();
    });
});
//# sourceMappingURL=checkout-billing-address.test.js.map