...
export { width, ICheckoutSectionContainerConfig, ICheckoutSectionContainerProps } from './checkout-section-container.props.autogenerated';

export {
    CheckoutSectionContainer,
    CheckoutSectionContainerView
};