...
export const mockGiftCardA: IGiftCardExtend = {
    Id: '123-456-111',
    Balance: 60,
    TenderTypeId: '12',
    Pin: '1111',
...
export const mockGiftCardB: IGiftCardExtend = {
    Id: '123-456-222',
    Balance: 50,
    TenderTypeId: '8'
};

export const mockGiftCardC: IGiftCardExtend = {
    Id: '123-456-333',
    Balance: 10,
    TenderTypeId: '8'
};
...
// @ts-ignore: Using partial for testing
export const mockGiftCardCheckoutState: CheckoutState = {
    giftCards: [],
    cardPrefix: '4111',
    tokenizedPaymentCard: undefined,
    shippingAddress: undefined,
...
export const mockResolvedCardTypes: CardTypeInfo[] = [
    {
        RecordId: 5637144585,
        TypeId: 'VISA',
        Name: 'Visa Card',
