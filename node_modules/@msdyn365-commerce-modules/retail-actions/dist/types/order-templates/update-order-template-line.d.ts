 ...
 */
export declare class UpdateOrderTemplateInput implements IActionInput {
 ...
 */
export declare const updateOrderTemplateInput: (inputData: ICreateActionContext<{}, {}>, orderTemplateId: string, productId: number, quantity: number, unitOfMeasure: string) => UpdateOrderTemplateInput;
/**
 ...
 */
export declare function updateOrderTemplateAction(input: UpdateOrderTemplateInput, ctx: IActionContext): Promise<ProductListLine>;
