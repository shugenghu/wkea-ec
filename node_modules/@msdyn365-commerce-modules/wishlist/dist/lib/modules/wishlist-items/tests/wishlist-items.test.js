import { wrapInRejectedAsyncResult, wrapInResolvedAsyncResult } from '@msdyn365-commerce-modules/retail-actions';
...
const productAvailabilityMockData = [{
...
const mockData = {
    products: wrapInResolvedAsyncResult([]),
...
const mockDataFailedResponse = {
    ...
    productAvailability: wrapInRejectedAsyncResult([])
};
const mockConfig = {
    heading: {
        text: 'Wishlist',
...
describe('WishlistItems', () => {
    ...
    beforeEach(() => {
        ...
        moduleProps = {
            ...buildMockModuleProps(mockData, mockActions, mockConfig2, mockContext),
    ...
    it('default maxQuantity should be 10 ', async () => {
        ...
        const wishlist = mount(React.createElement(WishlistItems, Object.assign({}, moduleProps)));
        ...
        const addToCartButton = mount(product.addToCartButton);
    ...
    it('Add to cart shows out of stock text', async () => {
        ...
        const noStockModuleProps = {
            ...buildMockModuleProps(mockData, mockActions, {}, outOfStockContext),
            resources: mockResources,
            renderView: jest.fn(props => React.createElement("div", { props: props }))
        };
        const wishlist = mount(React.createElement(WishlistItems, Object.assign({}, noStockModuleProps)));
    ...
    it('ProductStatusMessage shows and can be dismissed', async () => {
        ...
        const statusMessage = mount(product.productStatusMessage);
    ...
    it('Successful - remove item', async () => {
        ...
        const removeButton = mount(product.removeButton);
    ...
    it('renders empty message correctly', () => {
        mockData.products = wrapInRejectedAsyncResult([]);
        moduleProps = {
...
//# sourceMappingURL=wishlist-items.test.js.map