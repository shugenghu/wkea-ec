...
describe('WishlistItems - Unit Tests', () => {
    it('WishlistItemsDimensions renders correctly', () => {
        ...
        const component = render(React.createElement(WishlistItemDimension, Object.assign({}, mockPropsDimensions)));
    ...
    it('WishlistItemStatusMessage - LOADING - renders correctly', () => {
        ...
        const component = render(React.createElement(WishlistItemsStatusMessage, Object.assign({}, mockPropsMessage)));
        expect(component).toMatchSnapshot();
    });
    ...
    it('Wishlist Item addToCartButton fires handler event', () => {
        ...
        const addToCartButton = mount(component.addToCartButton);
