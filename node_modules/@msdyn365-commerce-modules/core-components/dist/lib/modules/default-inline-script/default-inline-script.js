...
class DefaultInlineScript extends React.PureComponent {
    ...
    render() {
        ...
        if (!source || source === '' || isAbsoluteUrl(source) || isRelativeUrl(source)) {
            logError('Invalid inline script - Empty inline source defined or a url is being used as a source. Use default-external-script to load scripts from an external or relative url.', this.props.telemetry);
            return null;
        }
...
//# sourceMappingURL=default-inline-script.js.map