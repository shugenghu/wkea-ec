...
import { IIndexPersonViewProps } from './index-person';

export default (props: IIndexPersonViewProps) => {
    return (
        <div className="wkea-index-person-content-top-right">
            ...
            <div className="wkea-index-person-content-top-right-welcome">
                Hi~欢迎回来
            <span>13753570654</span>
            </div>
            ...
            <hr />
            <button className="wkea-index-person-content-top-right-btn">
            ...
            <div className="wkea-index-person-content-top-right-need">
                <button>                <svg xmlns="http://www.w3.org/2000/svg" width="14.684" height="16.233" viewBox="0 0 14.684 16.233">
