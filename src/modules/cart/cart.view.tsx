        ...
        props.data.cart.result && <tr className={`wkea-order`}>
            <td>
                ...
                <div className="settlement">
                    <div className="price">总金额: <span className="sp1">￥</span><span className="sp2">{props.data.cart.result.cart.SubtotalSalesAmount}</span>
                    {/* 已选 {props.data.cart.result.cart.TotalItems} 件商品*/}</div> 
                    <div className="check_btn">{props.checkoutAsSignInUserButton}</div>
                </div>
            </td>
        </tr> || null
    );
