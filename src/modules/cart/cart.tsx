...
import {
    ...
    IWishlistActionSuccessResult, PromoCodeComponent, SaveCartToOrderTemplateComponent
    ...
    public render(): JSX.Element | null {
        ...
        const viewProps = {
                ...
                <div className="content">
                    ...
                    <div>
                        <div className="cart-content-top">
                            <div className="cart-content-top-choose">
                                <hr className="hractive" />
                                <span className="choose">1</span>
                                <span>我的购物车</span>
                            </div>
                            <div className="cart-content-top-choose">
                                <hr />
            ...
            checkoutAsSignInUserButton: (!isCartEmpty) ?
                (
                    <Button disabled={hasErrors} className={'msc-cart__btn-checkout'} href={checkoutURL} title={resources.checkoutButtonTitle}{...checkoutBySignInAttributes} >结算</Button>
                ) : null,
    ...
    private _getCartLines(): ICartlinesViewProps[] | null {
        ...
        return this.props.data.products && this.props.data.products.result && cart && cart.cart.CartLines && cart.cart.CartLines.length > 0 ? (
            CartLineItems({
                ...
                //removeCartAllButtonText:resources.removeCartAllButtonText,
