...
import { IIndexPersonInformationData } from './index-person-information.data';
import { IIndexPersonInformationProps, IIndexPersonInformationResources, IMyAccountLinksData } from './index-person-information.props.autogenerated';
...
export interface IHeaderViewProps extends IIndexPersonInformationProps<IIndexPersonInformationData>, IHeaderState {
 ...
 *
 * Header component
 * @extends {React.PureComponent<IIndexPersonInformationProps<IIndexPersonInformationData>>}
 */
class Header extends React.PureComponent<IIndexPersonInformationProps<IIndexPersonInformationData>, IHeaderState> {
    ...
    constructor(props: IIndexPersonInformationProps<IIndexPersonInformationData>) {
        super(props);
    ...
    public render(): JSX.Element | null {
        ...
        const viewProps: IHeaderViewProps = {
            ...(this.props as IIndexPersonInformationProps<IIndexPersonInformationData>),
            ...(this.state),
    ...
    private _getSigninButton(customer: Customer | undefined, user: MsDyn365.IRequestContextUser | undefined, resources: IIndexPersonInformationResources): React.ReactNode | undefined {
        ...
        return !customer && (
            <a
                ...
                onClick={onTelemetryClick(this.telemetryContent, payLoad, '登录')}
                {...attributes}
            >
                <span className='ms-header__signin-button-text' aria-hidden={true}>登录</span>
            </a>
        );
    }

    private _getSignOutButton(customer: Customer | undefined, user: MsDyn365.IRequestContextUser | undefined, resources: IIndexPersonInformationResources): React.ReactNode | undefined {
