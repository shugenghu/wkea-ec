...
import { IIndexPersonInformationConfig, IIndexPersonInformationResources } from '../index-person-information.props.autogenerated';
...
export const mockHeaderConfig: IIndexPersonInformationConfig = {
  logoLink: {
    linkUrl: {
...
export const mockResources: IIndexPersonInformationResources = {
...
export const getMockData = (totalItemsInCart: number = 0, accountNumber: string = '2', firstName: string = ''): IIndexPersonInformationData => {
  return {
...
export const getMockErrorData = (): IIndexPersonInformationData => {
  return {
    cart: <AsyncResult<ICartState>>{
      status: 'FAILED',
      result: undefined
